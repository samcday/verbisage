...
pub struct ResolvedBackendDef {
    ...
    // Per-backend path resolution overrides
    pub system_dir: Option<String>,
    pub user_dir: Option<String>,
    pub system_patterns: Option<Vec<String>>,
    pub user_patterns: Option<Vec<String>>,
...
fn resolve_file_backend(
    ...
    Ok(ResolvedBackendDef {
        ...
        capabilities,
        system_dir: def.system_dir.clone(),
        user_dir: def.user_dir.clone(),
        system_patterns: def.system_patterns.clone(),
        user_patterns: def.user_patterns.clone(),
        delimiter,
        has_header,
        word_index,
        freq_index,
